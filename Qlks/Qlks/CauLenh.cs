    ...
    public class CauLenh
    {
        ...
        {            
            try {
                ...
                SqlCommand cm = new SqlCommand("phongtrong", getConnection());
        ...
        public DataTable timhanvien1(string nhanvien)
        {

            SqlCommand cm = new SqlCommand("timnv", getConnection());
            cm.CommandType = CommandType.StoredProcedure;
            cm.Parameters.AddWithValue("@hoten", nhanvien);
            SqlDataAdapter da = new SqlDataAdapter(cm);
            da.Fill(dt);
        ...
        {            
            SqlCommand cm = new SqlCommand("themnv", getConnection());
            cm.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cm = new SqlCommand("suanv", getConnection());
            cm.CommandType = CommandType.StoredProcedure;           
            cm.Parameters.AddWithValue("@hoten", ht);
            cm.Parameters.AddWithValue("@phai", gt);
            cm.Parameters.AddWithValue("@diachi", dc);
